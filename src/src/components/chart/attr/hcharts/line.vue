    ...
    <attrCommon>
      <div class="oneblock">
        ...
        <div class="sdisplay">
          ...
          <select class="attr-select" :value="$bi.chart.getSetting('chart.type', 'line')" @change="$bi.chart.setSetting('chart.type', $event.target.value, _this)">
        ...
        <div class="sdisplay">
          ...
          <select class="attr-select" :value="$bi.chart.getSetting('plotOptions.line.stacking', '')" @change="$bi.chart.setSetting('plotOptions.line.stacking', $event.target.value, _this);$bi.chart.setSetting('plotOptions.spline.stacking', $event.target.value, _this)">
